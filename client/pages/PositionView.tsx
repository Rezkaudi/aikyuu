...
import { usePositionsStore, useCriteriaStore, useResumesStore, useAnalysisStore, useUIStore } from '../store';
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-[30px] p-12 max-w-5xl w-full">
        ...
        {/* Upload Area */}
        <div
          className={`w-full h-60 border-2 border-dashed border-gray-300 rounded-[10px] bg-white flex flex-col items-center justify-center gap-3 mb-8 transition-colors ${
            isDragOver ? 'border-aikyuu-primary bg-green-50' : ''
          }`}
